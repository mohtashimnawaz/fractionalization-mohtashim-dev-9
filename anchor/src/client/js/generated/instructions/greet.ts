...
import { FRACTIONALIZATIONSKYTRADE_PROGRAM_ADDRESS } from '../programs';
...
export type GreetInstruction<
  TProgram extends string = typeof FRACTIONALIZATIONSKYTRADE_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof FRACTIONALIZATIONSKYTRADE_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? FRACTIONALIZATIONSKYTRADE_PROGRAM_ADDRESS;
